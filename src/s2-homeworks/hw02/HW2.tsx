...
export const filterAffairs = (affairs: AffairType[], priorityFilter: FilterType): any => {
    let newAffairs = affairs.filter(affair => affair.priority === priorityFilter || priorityFilter === 'all')
